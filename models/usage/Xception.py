...
__all__ = ['Xception','Xception_BOT_MultiTask']
...
class Xception_BOT_MultiTask(nn.Module):

	def __init__(self, classes=2, loss={'xent'}, num_mid_flows=8, **kwargs):
		super(Xception_BOT_MultiTask, self).__init__()
		self.loss = loss
